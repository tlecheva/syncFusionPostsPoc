...
export function getData(dataCount) {
    ...
    let category = ['Energy', 'Financial', 'Technology', 'Industrial'];
    ...
    let tradeData = [];
    let Address = ["59 rue de l'Abbaye", "Luisenstr. 48", "Rua do Paço, 67", "2, rue du Commerce", "Boulevard Tirou, 255",
...
export function datasource() {
    ...
    let sport = ['Cricket', 'Football', 'Tennis', 'Golf', 'Chess', 'Dodgeball', 'Racket', 'Archery', 'Climbing', 'Hunting', 'Carrom', 'Tag', 'Novuss',
    ...
    let country = ['India', 'Australia', 'Ballesteros', 'Belgium', 'Brazil', 'England', 'Ethiopia', 'Finland', 'France', 'Germany', 'Britain',
...
export function createLazyLoadData() {
    ...
    for (let i = 0; i < 20000; i++) {
        lazyLoadData.push({
            ...
            'PostContent': product[Math.floor(Math.random() * product.length)],
            'CustomerName': customername[Math.floor(Math.random() * customername.length)],
            'ProductID': i,
...
export const categoryData = [
    {
        ...
        'Comment': 'This is a good idea, we can also add 10 cm to the 3D egde',
        'PostContent': `<p>The Rich Text Editor component is WYSIWYG ("what you see is what you get") editor that provides the best user experience to create and update the content. Users can format their content using standard toolbar commands.</p>`,
        'Comment': 'Good idea',
    ...
    {
        'PostName': 'Strickers',
        'PostContent':                  ` <p>Allows preview of modified content before saving it.</p>`      ,
        'CustomerName': 'Thomas Lechevalier',
        'QuantityPerUnit': '24 - 12 oz bottles',
        'Comment': 'Sorry I do not follow your idea',
        'Rating': 1,
        'Validated': true
    },
    {
        'PostName': 'Strickers',
        'PostContent': `<p>Voir le PDF ETUDE-C12-PRESENTATION v4.pdf dans documents</p>`,
        'CustomerName': 'Philippe Jachiet',
        'Comment': 'Ok for me',
    ...
    {
        'PostName': 'Transfer',
        'CustomerName': 'Aniseed Syrup',
        'PostContent': `<p>Handles images, hyperlinks, video, hyperlinks, uploads, etc.</p>`,
    ...
    {
        'PostName': 'Transfer',
        'CustomerName': 'Chef Anton\'s Cajun',
        'PostContent': `<p>Provides HTML view to edit the source directly for developers.</p>
        `,
